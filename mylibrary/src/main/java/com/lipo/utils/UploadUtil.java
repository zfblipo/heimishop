...
public class UploadUtil {
	 ...
	 *            请求的URL
	 */
	public void uploadFile(String filePath, final String fileKey, final String RequestURL,
		...
		final File file = new File(pathFile, "goods.jpg");
	...
	private void toUploadFile(File file, String fileKey, String RequestURL, Map<String, String> param) {
		...
		try {
			...
			if (res == 200) {
				...
				// SDCardMessage.WriteMessage(result);
				return;
			} else {
